...
# 最後の直線の長さ（m・目安）: (開催場, 芝/ダ) → m
# 芝の内/外回りがある場は get_course_layout で距離から分岐するため、ここにはダ・単一コースのみ
_STRAIGHT_LEN = {
    ('札幌', '芝'): 266, ('札幌', 'ダ'): 264,
    ('函館', '芝'): 262, ('函館', 'ダ'): 260,
    ('福島', '芝'): 292, ('福島', 'ダ'): 296,
...
# スタート→最初のコーナーまでの距離（m・目安）。gate_w を左右する。
# 括弧判定: <200m=極短(gate_w0.62) / <350m(0.50) / <550m(0.40) / ≥550m(0.28)
_FIRST_CORNER = {
    # 札幌
    ('札幌', '芝', 1200): 350, ('札幌', '芝', 1500): 380, ('札幌', '芝', 1800): 360,
    ('札幌', '芝', 2000): 210, ('札幌', '芝', 2600): 180,
    ('札幌', 'ダ', 1000): 280, ('札幌', 'ダ', 1700): 300, ('札幌', 'ダ', 2400): 250,
    # 函館
    ('函館', '芝', 1000): 280, ('函館', '芝', 1200): 300, ('函館', '芝', 1800): 220,
    ('函館', '芝', 2000): 250, ('函館', '芝', 2600): 350,
    ('函館', 'ダ', 1000): 290, ('函館', 'ダ', 1700): 310,
    # 福島
    ('福島', '芝', 1200): 410, ('福島', '芝', 1800): 300, ('福島', '芝', 2000): 360,
    ('福島', '芝', 2600): 200,
    ('福島', 'ダ', 1150): 380, ('福島', 'ダ', 1700): 390,
    # 新潟
    ('新潟', '芝', 1200): 420, ('新潟', '芝', 1400): 600, ('新潟', '芝', 1600): 550,
    ('新潟', '芝', 1800): 400, ('新潟', '芝', 2000): 260, ('新潟', '芝', 2200): 500,
    ('新潟', '芝', 2400): 320,
    ('新潟', 'ダ', 1200): 400, ('新潟', 'ダ', 1800): 430,
    # 東京
    ('東京', '芝', 1400): 300, ('東京', '芝', 1600): 540, ('東京', '芝', 1800): 160,
    ('東京', '芝', 2000): 130, ('東京', '芝', 2300): 350, ('東京', '芝', 2400): 350,
    ('東京', '芝', 2500): 540, ('東京', '芝', 3400): 350,
    ('東京', 'ダ', 1300): 445, ('東京', 'ダ', 1400): 445,
    ('東京', 'ダ', 1600): 640, ('東京', 'ダ', 2100): 240, ('東京', 'ダ', 2400): 240,
    # 中山
    ('中山', '芝', 1200): 275, ('中山', '芝', 1600): 240, ('中山', '芝', 1800): 190,
    ('中山', '芝', 2000): 405, ('中山', '芝', 2200): 200, ('中山', '芝', 2500): 200,
    ('中山', 'ダ', 1200): 500, ('中山', 'ダ', 1800): 375, ('中山', 'ダ', 2400): 180,
    # 中京
    ('中京', '芝', 1200): 430, ('中京', '芝', 1400): 410, ('中京', '芝', 1600): 315,
    ('中京', '芝', 2000): 315, ('中京', '芝', 2200): 550,
    ('中京', 'ダ', 1200): 390, ('中京', 'ダ', 1400): 490, ('中京', 'ダ', 1800): 290,
    ('中京', 'ダ', 1900): 315,
    # 京都
    ('京都', '芝', 1200): 600, ('京都', '芝', 1400): 620, ('京都', '芝', 1600): 710,
    ('京都', '芝', 1800): 490, ('京都', '芝', 2000): 310, ('京都', '芝', 2200): 280,
    ('京都', '芝', 2400): 340, ('京都', '芝', 3000): 225, ('京都', '芝', 3200): 230,
    ('京都', 'ダ', 1200): 310, ('京都', 'ダ', 1400): 320, ('京都', 'ダ', 1800): 285,
    ('京都', 'ダ', 1900): 280,
    # 阪神
    ('阪神', '芝', 1200): 210, ('阪神', '芝', 1400): 320, ('阪神', '芝', 1600): 444,
    ('阪神', '芝', 1800): 250, ('阪神', '芝', 2000): 350, ('阪神', '芝', 2200): 525,
    ('阪神', '芝', 2400): 450, ('阪神', '芝', 2600): 640, ('阪神', '芝', 3000): 435,
    ('阪神', 'ダ', 1200): 370, ('阪神', 'ダ', 1400): 350, ('阪神', 'ダ', 1800): 300,
    ('阪神', 'ダ', 2000): 250,
    # 小倉
    ('小倉', '芝', 1200): 480, ('小倉', '芝', 1700): 370, ('小倉', '芝', 1800): 290,
    ('小倉', '芝', 2000): 350, ('小倉', '芝', 2600): 200,
    ('小倉', 'ダ', 1000): 420, ('小倉', 'ダ', 1700): 350,
}
...
def get_course_layout(venue, surface, distance):
    ...
    if venue == '新潟' and surf == '芝':
        straight = 659 if d in (1400, 1600, 1800, 2000, 2200) else 359
    elif venue == '京都' and surf == '芝':
        straight = 404 if d in (1400, 1600, 1800, 2200, 2400) else 328
    elif venue == '阪神' and surf == '芝':
        straight = 474 if d in (1600, 1800, 2200, 2400, 2600, 3000) else 356
    else:
...
_FINISH_TUNE = {
    ...
    'w_spurt': 0.0,       # 末脚指数（上がり3F偏差の直近平均）。BT較正前は0（無効）
...
def predict_finish(horses, profiles=None, ctx=None, extras=None, tune=None):
    ...
    spurt_raw = {u: extras.get(u, {}).get('spurt') for u in us}
    spurt_n = (_rank_norm(spurt_raw) if any(v is not None for v in spurt_raw.values())
               else {u: 0.5 for u in us})
    ...
    for u in us:
        ...
        base = (t['w_pos4'] * p4 + t['w_kick'] * kick_n[u] + t['w_apt'] * apt_n[u]
                + t['w_power'] * power_n[u] + t['w_pop'] * pop_n[u]
                + t['w_spurt'] * spurt_n[u]) / wsum
...
def build_trajectory_figure(pace_map, title='フェーズ別 位置推移'):
    """
    pace_map（estimate_pace_map の出力）から、各馬のフェーズ別順位推移を
    バンプチャート（折れ線）で描画する。X=フェーズ, Y=隊列順位（1=先頭, 上が前）。
    """
    import plotly.graph_objects as go
    ...
    umabans = [r['umaban'] for r in pace_map[phases[0]]]
    name_of = {r['umaban']: r['name'] for r in pace_map[phases[0]]}
    style_of = {r['umaban']: r['style'] for r in pace_map[phases[0]]}

    ranks = {}
    for phase in phases:
        rows = pace_map[phase]
        by_x = sorted(rows, key=lambda r: -r['x'])
        ranks[phase] = {r['umaban']: rank + 1 for rank, r in enumerate(by_x)}

    fig = go.Figure()
    for u in sorted(umabans):
        ys = [ranks[ph].get(u, n) for ph in phases]
        color = STYLE_COLORS.get(style_of.get(u, ''), '#8d8d8d')
        fig.add_trace(go.Scatter(
            x=phases, y=ys, mode='lines+markers+text',
            line=dict(color=color, width=2.5),
            marker=dict(size=20, color=color, line=dict(color='white', width=1.2)),
            text=[str(u)] * len(phases),
            textfont=dict(color='white', size=10, family='Arial Black'),
            textposition='middle center',
            name=f"{u} {name_of.get(u, '')}",
            hovertext=[
                f"{u}番 {name_of.get(u, '')}<br>{ph}: {ranks[ph].get(u, '?')}番手"
                for ph in phases],
            hoverinfo='text',
        ))
    ...
    fig.update_layout(
        ...
        yaxis=dict(title='隊列順位', autorange='reversed', dtick=1,
                   tickfont=dict(size=11), gridcolor='rgba(255,255,255,0.1)'),
        height=max(340, 28 * n + 80),
