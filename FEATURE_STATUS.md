...
| ├ 🎯3連複おすすめエンジン | 決着タイプ判定→本線/②パターンで買い目10点 | 🟢 | trio_lean配線(10e582f) | 2026-06-23 |
...
| 🔍 Race Scanner (Batch) | 日付→全レース取得→妙味/決着タイプで並べ替え | 🟢 | 決着タイプ強化版統一(077cfeb) | 2026-06-23 |
| 🩸 血統SP | レースID→血統スコア順＋道悪判定／種牡馬しらべ | 🟢 | 道悪判定追加・小数第一位 | 2026-06-23 |
| 💰 BetSync(資金管理) | ガードレール/多肢ケリー/破産確率/台帳・Brier | 🟡 | [[project_betsync_money]] | — |
